        ...
        <nav class="navbar navbar-light bg-gray">
            <div class="container">
              <a class="navbar-brand" href="#">
                <img class="rounded-circle" src="{{URL::asset("image/Bistro_logo.png")}}" alt="" width="50" height="50">
              </a>
            </div>
            @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class=" text-decoration-none ml-4 text-sm text-dark  underline">Register</a>
                    @endif
                @endauth
            </div>
        @endif
